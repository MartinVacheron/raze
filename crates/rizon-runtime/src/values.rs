use colored::*;
use ecow::EcoString;
use rizon_frontend::ast::stmt::{BlockStmt, FnDeclStmt, StructStmt};
use std::{
    cell::RefCell,
    collections::{
...
use crate::{
    ...
    native_functions::RizonNativeFn,
};
    ...
    fn call(
        ...
        for (p, v) in self.params.iter().zip(args) {
            new_env
                ...
                .map_err(|_| RizonResult::new(CallErr::WrongFnParamDecl, None))?;
        }
