...
impl RizonReport for ParserTestErr {
    fn get_err_msg(&self) -> String {
        String::from("")
    }
}

type RizonResParserTestErr = RizonResult<ParserTestErr>;
...
impl VisitStmt<StmtInfos, ParserTestErr> for TestParser {
    fn visit_expr_stmt(&mut self, stmt: &ExprStmt) -> Result<StmtInfos, RizonResult<ParserTestErr>> {
    ...
    fn visit_print_stmt(&mut self, stmt: &PrintStmt) -> Result<StmtInfos, RizonResult<ParserTestErr>> {
        let expr = stmt.expr.accept(self)?;
    ...
    fn visit_var_decl_stmt(
        &mut self,
        stmt: &VarDeclStmt,
    ) -> Result<StmtInfos, RizonResult<ParserTestErr>> {
        let mut infos = StmtInfos::default();
    ...
    fn visit_block_stmt(&mut self, stmt: &BlockStmt) -> Result<StmtInfos, RizonResult<ParserTestErr>> {
    ...
    fn visit_if_stmt(&mut self, stmt: &IfStmt) -> Result<StmtInfos, RizonResult<ParserTestErr>> {
    ...
    fn visit_while_stmt(&mut self, stmt: &WhileStmt) -> Result<StmtInfos, RizonResult<ParserTestErr>> {
        let condition = stmt.condition.accept(self)?;
    ...
    fn visit_for_stmt(&mut self, stmt: &ForStmt) -> Result<StmtInfos, RizonResult<ParserTestErr>> {
    ...
    fn visit_fn_decl_stmt(&mut self, stmt: &FnDeclStmt) -> Result<StmtInfos, RizonResult<ParserTestErr>> {
    ...
    fn visit_return_stmt(&mut self, stmt: &ReturnStmt) -> Result<StmtInfos, RizonResult<ParserTestErr>> {
    ...
    fn visit_struct_stmt(&mut self, _stmt: &StructStmt) -> Result<StmtInfos, RizonResult<ParserTestErr>> {
        todo!()
    }
}
...
impl TestParser {
    pub fn get_all_infos(&mut self, nodes: &[Stmt]) -> Result<&StmtInfos, RizonResParserTestErr> {
        for node in nodes {
...
impl VisitExpr<ExprInfos, ParserTestErr> for TestParser {
    fn visit_int_literal_expr(
        &mut self,
        expr: &IntLiteralExpr,
    ) -> Result<ExprInfos, RizonResParserTestErr> {
    ...
    fn visit_binary_expr(&mut self, expr: &BinaryExpr) -> Result<ExprInfos, RizonResParserTestErr> {
        let mut infos = ExprInfos::default();
    ...
    fn visit_grouping_expr(&mut self, expr: &GroupingExpr) -> Result<ExprInfos, RizonResParserTestErr> {
        let mut infos = ExprInfos::default();
    ...
    fn visit_unary_expr(&mut self, expr: &UnaryExpr) -> Result<ExprInfos, RizonResParserTestErr> {
        let mut infos = ExprInfos::default();
    ...
    fn visit_assign_expr(&mut self, expr: &AssignExpr) -> Result<ExprInfos, RizonResult<ParserTestErr>> {
        let mut infos = ExprInfos::default();
    ...
    fn visit_logical_expr(
        &mut self,
        expr: &LogicalExpr,
    ) -> Result<ExprInfos, RizonResult<ParserTestErr>> {
        let mut infos = ExprInfos::default();
    ...
    fn visit_call_expr(&mut self, expr: &CallExpr) -> Result<ExprInfos, RizonResult<ParserTestErr>> {
        let mut infos = ExprInfos::default();
    ...
    fn visit_get_expr(&mut self, _: &GetExpr) -> Result<ExprInfos, RizonResult<ParserTestErr>> {
        todo!()
    }
    
    fn visit_set_expr(&mut self, _: &SetExpr) -> Result<ExprInfos, RizonResult<ParserTestErr>> {
        todo!()
    }
    
    fn visit_self_expr(&mut self, _: &crate::ast::expr::SelfExpr) -> Result<ExprInfos, RizonResult<ParserTestErr>> {
        todo!()
    }
    
    fn visit_is_expr(&mut self, _: &crate::ast::expr::IsExpr) -> Result<ExprInfos, RizonResult<ParserTestErr>> {
        todo!()
    }
}
